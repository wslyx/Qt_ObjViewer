...
CustomMesh *objLoader::loadMesh(QString filePath)
{
    ...
    if(scene->mNumMeshes > 0)
    {
        ...
        for( int vec = 0; vec < vertices_length; vec++)
        {
            ...
            {
                vertex.setTexCoords(QVector2D(0,0));
            }
...
//            std::string path = "/home/yaxilee/QtProject/QtObjViewer-master/test_data/02def2534771db1f6049c5531a9d3169.isomap.png";
...
CustomMesh *objLoader::loadTextureMesh(QString filePath,std::string TexturePath)
{
    Assimp::Importer importer;                      // 加载器
    ...
    if(scene->mNumMeshes > 0)
    {
        ...
        qDebug() << "\n" << "faces: " << aimesh->HasFaces() << aimesh->mNumFaces<<"\n"
                 << "vertices: " << aimesh->mNumVertices<<"\n"
                 << "textureCoords: " << aimesh->HasTextureCoords(0) << aimesh->HasTextureCoords(1)<<"n"
                 << "hasVertexColors: " << aimesh->HasVertexColors(0) << aimesh->HasVertexColors(1)<<"\n"
                 << "material index: " << aimesh->mMaterialIndex<<"\n"
                 << "normals: " << aimesh->HasNormals()<<"\n";
...
//            std::string path = textPath.C_Str();
//            std::string path = "/home/yaxilee/QtProject/QtObjViewer-master/test_data/02def2534771db1f6049c5531a9d3169.isomap.png";
            QString absolutioinPath = QString::fromStdString(TexturePath);
